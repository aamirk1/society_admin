...
import 'package:society_admin/screens/Note/ViewNote/CreditNoteView.dart';
// ignore: must_be_immutable
class ReceiptCreditNote extends StatefulWidget {
  ReceiptCreditNote(
      {super.key,
  ...
  @override
  State<ReceiptCreditNote> createState() => _ReceiptCreditNoteState();
}

class _ReceiptCreditNoteState extends State<ReceiptCreditNote> {
  bool isLoading = true;
                      ...
                      itemBuilder: (context, index) {
                        return Column(children: [
                          Padding(
                            ...
                            child: ListTile(
                              title: Text(
                                'Credit Note No.: ${noteNumberList[index]}',
                              ),
                              onTap: () {
                                Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (context) => ViewCreditNote(
