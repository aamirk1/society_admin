...
class DateOfGatePass extends StatefulWidget {
  DateOfGatePass(
      {super.key,
  ...
  @override
  State<DateOfGatePass> createState() => _DateOfGatePassState();
}

class _DateOfGatePassState extends State<DateOfGatePass> {
  List<dynamic> colors = [
        ...
        return Card(
          ...
          child: Padding(
            ...
            child: ListTile(
              ...
              title: Text(
                widget.dataList[index]['gatePassType'],
